...
export const { useGetAllFacultyQuery,useAddAcademicFacultyMutation,useGetAllSemestersQuery,useAddAcademicSemesterMutation,useAddAcademicDepartmentMutation ,useGetAllDepartmentQuery} = academicManagementApi;
